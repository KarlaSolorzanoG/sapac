        ...
        <form name="frmEditar" id="frmEditar" method="POST" action="http://localhost/sapac/controlador/RH/EDatosPersonales.php?idEmp=<?= $idEmp ?>">
            ...
            <fieldset>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="apellidoP" name="apellidoP" value="<?= $datos->apellidoP ?>" required>
                </div>

                <div class="mb-3">
                    <label for="apellidoM" class="form-label">Apellido Materno:</label>
                    <input type="text" class="form-control" id="apellidoM" name="apellidoM" value="<?= $datos->apellidoM ?>" required>
                </div>

                <div class="mb-3">
                    <label for="fechaNacimiento">Fecha de Nacimiento:</label>
                    <input type="date" class="form-control" id="fechaNacimiento" name="fechaNacimiento" value="<?= $datos->feNac ?>" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" id="telefono" name="telefono" value="<?= $datos->telefono ?>" required>
                </div>

                <div class="mb-3">
                    <label for="correo">Correo Electrónico:</label>
                    <input class="form-control" type="email" id="correo" name="correo" value="<?= $datos->correo ?>" required>
                </div>

                <div class="mb-3">
                    <label for="domicilio">Domicilio:</label>
                    <input class="form-control" type="text" id="domicilio" name="domicilio" value="<?= $datos->domicilio ?>" required></input>
                </div>
            </fieldset>
